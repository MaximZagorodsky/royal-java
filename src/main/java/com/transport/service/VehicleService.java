...
public interface VehicleService {
    ...
    List<Vehicle> saveAll(List<Vehicle> list);

    List<Vehicle> findAvaliableVehicles(String withPeriodAMAndPM);

    List<Vehicle> findAvaliableVehicles();

    List<Vehicle> findAvaliableVehicleByType(String type);
}
