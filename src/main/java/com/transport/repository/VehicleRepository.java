...
public interface VehicleRepository extends JpaRepository<Vehicle, Integer> {
    ...
    List<Vehicle> findByIsAvaliableTrueAndBookingDateIsNullAndPeriodOfDayLike(String period);

    List<Vehicle> findByIsAvaliableTrueAndBookingDateIsNull();

    List<Vehicle> findByIsAvaliableTrueAndBookingDateIsNullAndTypeLike(String type);
