...
public class CategoryUtilTest {
    private Logger log = LoggerFactory.getLogger( CategoryUtilTest.class);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleMonday(){
       int category = CategoryUtil.getRoyalMovingPriceCategoryByDay(new DateTime(MONDAY_11_07_2016));
        log.info("testGetRoyalMovingPriceCategoryBySimpleMonday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleTuesday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryBySimpleTuesday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleWednesday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryBySimpleWednesday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleThursday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryBySimpleThursday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleFriday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryBySimpleFriday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleSaturday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryBySimpleSaturday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryBySimpleSunday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryBySimpleSunday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryByEndOfMonthTuesday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryByEndOfMonthTuesday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryByEndOfMonthFriday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryByEndOfMonthFriday,cateogry = "+category);
    ...
    public void testGetRoyalMovingPriceCategoryByEndOfMonthSunday(){
        ...
        log.info("testGetRoyalMovingPriceCategoryByEndOfMonthSunday,cateogry = "+category);
